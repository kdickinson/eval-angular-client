angular.module('factories.test.data',[])
.factory('testDataFactory', ['$http', function($http) {
    data = {
        currentQuestion: 0,
        test: {
            questions: [{
     ...
     var getNextQuestion = function() {
         if (++data.currentQuestion < data.test.length) {
             return data.test.questions[data.currentQuestion];
         } else {
             return null;
         }
     };
